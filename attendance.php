...
<head>
 	...
 	<title>Faculty Monitoring Dashboard - Attendance</title>
...
<div class="dashboard-layout">
 	...
 	<main class="main-content">
 		...
 		<div class="content-header">
 			<h2 id="content-title">Faculty Attendance</h2>
 									...
 									foreach ($data as $id => $schedule) {
 										...
 										echo "</td>
 											...
 											<td class='action-icons'>
 												<a href='edit.php?id=$id' class='btn btn-sm btn-outline-primary' title='Edit'><i class='bi bi-pencil-square'></i></a>
 												<a href='delete.php?id=$id' class='btn btn-sm btn-outline-danger' title='Delete' onclick='return confirm(\"Are you sure you want to delete this record?\")'><i class='bi bi-trash'></i></a>
 											</td>
 										</tr>";
 									}
 								} else {
  ...
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
 	<div class="modal-content">
 	  <div class="modal-header">
 		<h5 class="modal-title" id="addRecordModalLabel">Add New Schedule</h5>
...
<script src="attendance_script.js?v=<?php echo time(); ?>"></script>
